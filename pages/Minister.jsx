    ...
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="bg-gay-100 rounded-lg shadow-lg p-6">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          Washington D.C. Formerly a mathematics professor at the University of
          Lagos, Nigeria, he started working with the founder of RCCG by
          ...
          icon and preacher of God’s Word, he was selected in 2008 as one of the
          world’s 50 most influential people by Newsweek magazine, USA. Born on
          March 2, 1942 into a humble family in the village of Ifewara, Osun
          State, located in the South-Western part of Nigeria. His poor family
          background seemed at first glance capable of confining him to a life
          of lack. Brilliant, calm and reticent, his early teachers had little
          doubt that the lad had a scholarly aura and was cut for academia. The
          bruising truth was that Enoch’s tall ambition to pursue a career in
          academia was irreconcilable with the abject poverty of his family. Not
          to be deterred, his parents sold a few cherished possessions and
          borrowed from kind neighbors just to ensure that their son’s dream was
          not held back.
